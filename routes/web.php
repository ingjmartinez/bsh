...
use App\Http\Controllers\IncentivosAdministrativosController;
use App\Http\Controllers\IncentivosAdministrativosReportController;
...
use App\Http\Controllers\ReporteBonosController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::redirect('/incentivos/incentivos-administrativos', '/incentivos/calculo-de-incentivos');
    Route::get('/incentivos/calculo-de-incentivos', [IncentivosAdministrativosController::class, 'index'])
        ->name('incentivos.calculo.index');
    Route::get('/incentivos/calculo-de-incentivos/reporte', [IncentivosAdministrativosController::class, 'reporte'])
        ->name('incentivos.calculo.reporte');
    Route::get('/incentivos/calculo-de-incentivos/reporte-bono', [IncentivosAdministrativosController::class, 'reporteBono'])
        ->name('incentivos.calculo.reporte-bono');
    Route::post('/incentivos/calculo-de-incentivos/periodo', [IncentivosAdministrativosController::class, 'guardarPeriodo'])
        ->name('incentivos.calculo.periodo.guardar');
    Route::get('/incentivos/calculo-de-incentivos/calendario', [IncentivosAdministrativosController::class, 'calendario'])
        ->name('incentivos.calculo.calendario');
    Route::post('/incentivos/calculo-de-incentivos/calendario/terminales/reconocer', [IncentivosAdministrativosController::class, 'reconocerTerminalesCalendario'])
        ->name('incentivos.calculo.calendario.terminales.reconocer');
    Route::put('/incentivos/calculo-de-incentivos/calendario', [IncentivosAdministrativosController::class, 'guardarCalendario'])
        ->name('incentivos.calculo.calendario.guardar');
    Route::post('/incentivos/calculo-de-incentivos/faltantes', [IncentivosAdministrativosReportController::class, 'faltantesReporteNuevoIncentivoV5'])
        ->name('incentivos.calculo.faltantes');
    Route::post('/incentivos/calculo-de-incentivos/desvinculados', [IncentivosAdministrativosReportController::class, 'desvinculadosReporteNuevoIncentivoV5'])
        ->name('incentivos.calculo.desvinculados');
    Route::post('/incentivos/calculo-de-incentivos/administrativos/sincronizar', [IncentivosAdministrativosReportController::class, 'sincronizarAdministrativosReporteNuevoIncentivoV5'])
        ->name('incentivos.calculo.sincronizar');
    Route::post('/incentivos/calculo-de-incentivos/terminales-excluidas/reconocer', [IncentivosAdministrativosReportController::class, 'reconocerTerminalesExcluidasReporteNuevoIncentivoV5'])
        ->name('incentivos.calculo.terminales-excluidas.reconocer');
    Route::get('/incentivos/calculo-de-incentivos/terminales-excluidas/plantilla', [IncentivosAdministrativosReportController::class, 'plantillaTerminalesExcluidasReporteNuevoIncentivoV5'])
        ->name('incentivos.calculo.terminales-excluidas.plantilla');
    Route::get('/incentivos/calculo-de-incentivos/terminales-excluidas', [IncentivosAdministrativosReportController::class, 'listarTerminalesExcluidasIncentivoReporteNuevoIncentivoV5'])
        ->name('incentivos.calculo.terminales-excluidas.index');
    Route::post('/incentivos/calculo-de-incentivos/terminales-excluidas', [IncentivosAdministrativosReportController::class, 'guardarTerminalesExcluidasIncentivoReporteNuevoIncentivoV5'])
        ->name('incentivos.calculo.terminales-excluidas.guardar');
