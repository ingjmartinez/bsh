                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Incumplimiento de Horario por Agencia Lotedom</h4>
                            ...
                            <div class="card-header">
                                <div class="row g-2 align-items-end">
                                    ...
                                    <div class="col-md-6 text-md-end">
                                        ...
                                        <a href="{{ route('agencias-lotedom.index') }}" class="btn btn-light">
...
<script>
    ...
    function cargarData() {
        ...
        $.ajax({
            url: '{{ route('agencias-lotedom.incumplimientos.list') }}',
            method: 'GET',
            data: {
                fecha: fecha,
                solo_incumplidas: 0
