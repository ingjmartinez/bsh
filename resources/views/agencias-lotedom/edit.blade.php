                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Editar Agencia Lotedom</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('inicio.index') }}">Inicio</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('mantenimiento.index') }}">Mantenimientos</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('agencias-lotedom.index') }}">Agencias Lotedom</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Datos de la Agencia Lotedom</h5>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('agencias-lotedom.update', $agencia->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="d-flex flex-column flex-sm-row justify-content-end gap-2 mt-3">
                                        <a href="{{ route('agencias-lotedom.index') }}" class="btn btn-secondary">
