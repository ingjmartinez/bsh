...
@section('content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex flex-column flex-md-row align-items-start align-md-items-center justify-content-between">
                            <h4 class="mb-3 mb-md-0">Mantenimiento de Agencias Lotedom</h4>
                            ...
                            <div class="page-title-right w-100 w-md-auto">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Agencias Lotedom</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header">
                                <div class="row align-items-start align-md-items-center">
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        <h5 class="card-title mb-0">Lista de Agencias Lotedom</h5>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="row g-2">
                                            <div class="col-6 col-md-3 d-grid">
                                                <a href="{{ route('agencias-lotedom.incumplimientos') }}" class="btn btn-warning btn-sm">
                                            ...
                                            <div class="col-6 col-md-3 d-grid">
                                                <a href="{{ route('agencias-lotedom.export') }}" class="btn btn-info btn-sm">
                                                    <i class="ri-download-2-line align-bottom me-1"></i><span class="d-none d-md-inline">Exportar</span><span class="d-md-none">Exp.</span>
                                                </a>
                                            </div>
                                            <div class="col-6 col-md-3 d-grid">
                                                <a href="{{ route('agencias-lotedom.create') }}" class="btn btn-primary btn-sm">
                            ...
                            <div class="card-body p-2 p-md-3">
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <small class="text-muted d-block">Agencias Lotedom</small>
                                            <h5 class="mb-0 text-info" id="countAgenciasLotedom">0</h5>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex gap-2 flex-wrap">
                                        <button type="button" class="btn btn-sm btn-outline-info" id="btnFiltroEmpresaLotedom">Lotedom</button>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('agencias-lotedom.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="importModalLabel">Importar Agencias Lotedom desde Excel</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                    ...
                    <div class="modal-footer d-flex gap-2">
                        <a href="{{ route('agencias-lotedom.template') }}" class="btn btn-outline-primary btn-sm">
    ...
    <div class="modal fade" id="massUpdateModal" tabindex="-1" aria-labelledby="massUpdateModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('agencias-lotedom.mass-update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="massUpdateModalLabel">Actualizaci&oacute;n masiva de Agencias Lotedom</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <a href="{{ route('agencias-lotedom.mass-update-template') }}" class="btn btn-outline-primary btn-sm">
    ...
    <div class="modal fade" id="noRegistradasModal" tabindex="-1" aria-labelledby="noRegistradasModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="noRegistradasModalLabel">Terminales no registradas desde Ventas por Usuario Lotedom</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="d-flex justify-content-between align-items-center mb-2 flex-wrap gap-2">
                        <span class="text-muted small" id="noRegistradasRangoTexto">Sincronizable desde ventas por usuario</span>
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            ...
                            <button type="button" class="btn btn-sm btn-warning" id="btnRegistrarNoRegistradasMasivo">
                                <i class="ri-add-box-line me-1"></i>Sincronizar terminales
                            </button>
                        </div>
                    </div>
                    <div class="table-responsive">
                    ...
                    <div class="small text-muted mt-2" id="sinNoRegistradasTexto" style="display:none;">
                        No hay terminales pendientes por sincronizar desde ventas por usuario.
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        function renderNoRegistradasModal() {
            ...
            noRegistradasRangoTexto.text(desde && hasta ? ('Rango detectado en ventas: ' + desde + ' a ' + hasta) : 'Sincronizable desde ventas por usuario');
        ...
        function cargarNoRegistradasVentaFija(mostrarError) {
            $.ajax({
                url: '{{ route('agencias-lotedom.no-registradas-desde-ventas') }}',
                method: 'GET',
        ...
        function cargarAgenciasParaActualizar(mostrarError) {
            $.ajax({
                url: '{{ route('agencias-lotedom.para-actualizar') }}',
                method: 'GET',
                success: function(response) {
        ...
        function cargarAgenciasInactivas(mostrarError) {
            ...
            $.ajax({
                url: '{{ route('agencias-lotedom.inactivas') }}',
                method: 'GET',
                success: function(response) {
        ...
        function cargarAgenciasSinVentaTreintaDias(mostrarError) {
            ...
            $.ajax({
                url: '{{ route('agencias-lotedom.sin-venta-30-dias') }}',
                method: 'GET',
                success: function(response) {
        ...
        function cargarAgenciasInactivasConVentas(mostrarError) {
            ...
            $.ajax({
                url: '{{ route('agencias-lotedom.inactivas-con-venta-30-dias') }}',
                method: 'GET',
                success: function(response) {
        ...
        function cargarAgenciasNoRegistradasConVentas(mostrarError) {
            ...
            $.ajax({
                url: '{{ route('agencias-lotedom.no-registradas-con-venta-30-dias') }}',
                method: 'GET',
                success: function(response) {
        ...
        function desactivarAgenciasSinVentaMasivo() {
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '{{ route('agencias-lotedom.sin-venta-30-dias.desactivar') }}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
        ...
        function ejecutarActualizacionEstatusAgencia(agenciaId, estatus, button) {
            ...
            $.ajax({
                url: '{{ route('agencias-lotedom.actualizar-estatus') }}',
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
        ...
        function registrarNoRegistradasMasivo() {
            ...
            Swal.fire({
                icon: 'question',
                    title: 'Sincronizar agencias desde ventas',
                    text: 'Se sincronizaran ' + total.toLocaleString('es-DO') + ' terminales no registradas detectadas en ventas por usuario.',
                showCancelButton: true,
                ...
                Swal.fire({
                        ...
                        text: 'Procesando terminales detectadas en ventas por usuario...',
                    allowOutsideClick: false,
                    allowEscapeKey: false,
                    didOpen: function() {
                        Swal.showLoading();
                ...
                $.ajax({
                    url: '{{ route('agencias-lotedom.no-registradas.sincronizar-desde-ventas') }}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                        ...
                        Swal.fire({
                            ...
                            html: `
                                <div class="text-start">
                                    ...
                                    <div><strong>Omitidas:</strong> ${Number(response.omitidas || 0).toLocaleString('es-DO')}</div>
                                    <div><strong>Total detectadas:</strong> ${Number(response.total_solicitadas || 0).toLocaleString('es-DO')}</div>
                                </div>
                            `,
                            confirmButtonText: 'Entendido'
                        });
                    ...
                    error: function(xhr) {
                        var msg = xhr?.responseJSON?.message || 'No se pudieron sincronizar las terminales desde ventas por usuario.';
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: msg
        ...
        function registrarTerminalNoRegistrada(terminal, button) {
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '{{ route('agencias-lotedom.no-registradas.registrar-terminal') }}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        terminal: terminal
        ...
        function aplicarEmpresaBotones() {
            $('#btnFiltroEmpresaLotedom').removeClass('btn-outline-info').addClass('btn-info');
        }
        ...
        var table = $('#tableAgencias').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route('agencias-lotedom.list') }}',
                data: function(d) {
                ...
                dataSrc: function(json) {
                    ...
                    countAgenciasLotedom.text((json.total_lotedom || 0).toLocaleString('es-DO'));
                    return json.data || [];
                }
            },
            responsive: true,
                    ...
                    render: function(data, type, row) {
                        return `
                            <div class="d-flex gap-1 justify-content-center flex-nowrap">
                                <a href="/agencias-lotedom/${row.id}/edit" class="btn btn-sm btn-success" title="Editar">
                                    <i class="ri-pencil-line"></i>
                                </a>
        ...
        $('#btnFiltroEmpresaLotedom').on('click', function() {
            empresaFiltro = 'lotedom';
            aplicarEmpresaBotones();
            table.ajax.reload();
        });
        ...
        $('#tableAgencias').on('click', '.btn-delete', function() {
            var id = $(this).data('id');
            var form = $('#deleteForm');
            form.attr('action', '/agencias-lotedom/' + id);
        ...
        btnPreviewTerminalesMasivo.on('click', function() {
            ...
            $.ajax({
                url: '{{ route('agencias-lotedom.mass-update-preview') }}',
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    var listado = noEncontradas.length
                        ...
                        : '<small class="text-success">Todas las terminales le&iacute;das existen en la tabla de agencias Lotedom.</small>';
