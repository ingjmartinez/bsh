                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('agencias-lotedom.index') }}">Agencias</a></li>
                                ...
                                <div class="row g-2 align-items-end">
                                    ...
                                    <div class="col-md-4">
                                        <div class="d-flex flex-wrap justify-content-md-end gap-2">
                                            ...
                                            <a href="{{ route('agencias-lotedom.index') }}" class="btn btn-light btn-sm">
...
<script>
    ...
    const URL_LIST = '{{ route('agencias-lotedom.asistencia-comparativa.list') }}';
    const URL_SEND_MAIL_COORD = '{{ route('agencias-lotedom.asistencia-comparativa.send-mail') }}';
    ...
    async function solicitarCorreoYEnviar(row) {
        ...
        $.ajax({
            url: '{{ route('agencias-lotedom.incumplimientos.send-mail') }}',
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                email: result.value,
