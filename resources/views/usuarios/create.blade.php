                            ...
                            <div class="card-body">
                                <form action="{{ route('usuarios.store') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 mb-3">
                                            <label for="password" class="form-label">Contrase̱a <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                        ...
                                        <div class="col-12 col-md-6 mb-3">
                                            <label for="password_confirmation" class="form-label">Confirmar Contrase̱a <span class="text-danger">*</span></label>
                                            <div class="input-group">
