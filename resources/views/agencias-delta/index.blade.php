...
@section('content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex flex-column flex-md-row align-items-start align-md-items-center justify-content-between">
                            <h4 class="mb-3 mb-md-0">Mantenimiento de Agencias Delta</h4>
                            ...
                            <div class="page-title-right w-100 w-md-auto">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Agencias Delta</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header">
                                <div class="row align-items-start align-md-items-center">
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        <h5 class="card-title mb-0">Lista de Agencias Delta</h5>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="row g-2">
                                            <div class="col-6 col-md-3 d-grid">
                                                <a href="{{ route('agencias-delta.incumplimientos') }}" class="btn btn-warning btn-sm">
                                            ...
                                            <div class="col-6 col-md-3 d-grid">
                                                <a href="{{ route('agencias-delta.export') }}" class="btn btn-info btn-sm">
                                                    <i class="ri-download-2-line align-bottom me-1"></i><span class="d-none d-md-inline">Exportar</span><span class="d-md-none">Exp.</span>
                                                </a>
                                            </div>
                                            <div class="col-6 col-md-3 d-grid">
                                                <a href="{{ route('agencias-delta.create') }}" class="btn btn-primary btn-sm">
                            ...
                            <div class="card-body p-2 p-md-3">
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <small class="text-muted d-block">Agencias Delta</small>
                                            <h5 class="mb-0 text-info" id="countAgenciasDelta">0</h5>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex gap-2 flex-wrap">
                                        <button type="button" class="btn btn-sm btn-outline-info" id="btnFiltroEmpresaDelta">Delta</button>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('agencias-delta.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="importModalLabel">Importar Agencias Delta desde Excel</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                    ...
                    <div class="modal-footer d-flex gap-2">
                        <a href="{{ route('agencias-delta.template') }}" class="btn btn-outline-primary btn-sm">
    ...
    <div class="modal fade" id="massUpdateModal" tabindex="-1" aria-labelledby="massUpdateModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('agencias-delta.mass-update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="massUpdateModalLabel">Actualizaci&oacute;n masiva de Agencias Delta</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <a href="{{ route('agencias-delta.mass-update-template') }}" class="btn btn-outline-primary btn-sm">
    ...
    <div class="modal fade" id="noRegistradasModal" tabindex="-1" aria-labelledby="noRegistradasModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="noRegistradasModalLabel">Terminales no registradas desde ventas Delta</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="d-flex justify-content-between align-items-center mb-2 flex-wrap gap-2">
                        <span class="text-muted small" id="noRegistradasRangoTexto">Sincronizable desde ventas Delta</span>
                    ...
                    <div class="small text-muted mt-2" id="sinNoRegistradasTexto" style="display:none;">
                        No hay terminales pendientes por sincronizar desde ventas Delta.
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        function renderNoRegistradasModal() {
            ...
            noRegistradasRangoTexto.text(desde && hasta ? ('Rango detectado en ventas Delta: ' + desde + ' a ' + hasta) : 'Sincronizable desde ventas Delta');
        ...
        function cargarNoRegistradasVentaFija(mostrarError) {
            $.ajax({
                url: '{{ route('agencias-delta.no-registradas-desde-ventas') }}',
                method: 'GET',
        ...
        function cargarAgenciasParaActualizar(mostrarError) {
            $.ajax({
                url: '{{ route('agencias-delta.para-actualizar') }}',
                method: 'GET',
                success: function(response) {
        ...
        function cargarAgenciasInactivas(mostrarError) {
            ...
            $.ajax({
                url: '{{ route('agencias-delta.inactivas') }}',
                method: 'GET',
                success: function(response) {
        ...
        function cargarAgenciasSinVentaTreintaDias(mostrarError) {
            ...
            $.ajax({
                url: '{{ route('agencias-delta.sin-venta-30-dias') }}',
                method: 'GET',
                success: function(response) {
        ...
        function cargarAgenciasInactivasConVentas(mostrarError) {
            ...
            $.ajax({
                url: '{{ route('agencias-delta.inactivas-con-venta-30-dias') }}',
                method: 'GET',
                success: function(response) {
        ...
        function cargarAgenciasNoRegistradasConVentas(mostrarError) {
            ...
            $.ajax({
                url: '{{ route('agencias-delta.no-registradas-con-venta-30-dias') }}',
                method: 'GET',
                success: function(response) {
        ...
        function desactivarAgenciasSinVentaMasivo() {
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '{{ route('agencias-delta.sin-venta-30-dias.desactivar') }}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
        ...
        function ejecutarActualizacionEstatusAgencia(agenciaId, estatus, button) {
            ...
            $.ajax({
                url: '{{ route('agencias-delta.actualizar-estatus') }}',
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
        ...
        function registrarNoRegistradasMasivo() {
            ...
            Swal.fire({
                icon: 'question',
                    ...
                    text: 'Se sincronizaran ' + total.toLocaleString('es-DO') + ' terminales no registradas detectadas en ventas Delta.',
                showCancelButton: true,
                ...
                Swal.fire({
                        ...
                        text: 'Procesando terminales detectadas en ventas Delta...',
                    allowOutsideClick: false,
                    allowEscapeKey: false,
                    didOpen: function() {
                        Swal.showLoading();
                ...
                $.ajax({
                    url: '{{ route('agencias-delta.no-registradas.sincronizar-desde-ventas') }}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    ...
                    error: function(xhr) {
                        var msg = xhr?.responseJSON?.message || 'No se pudieron sincronizar las terminales desde ventas Delta.';
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: msg
        ...
        function registrarTerminalNoRegistrada(terminal, button) {
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '{{ route('agencias-delta.no-registradas.registrar-terminal') }}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        terminal: terminal
        ...
        function aplicarEmpresaBotones() {
            $('#btnFiltroEmpresaDelta').removeClass('btn-outline-info').addClass('btn-info');
        }
        ...
        var table = $('#tableAgencias').DataTable({
            ...
            ajax: {
                ...
                dataSrc: function(json) {
                    ...
                    countAgenciasDelta.text((json.total_delta || 0).toLocaleString('es-DO'));
                    return json.data || [];
                }
            },
            responsive: true,
                    ...
                    render: function(data, type, row) {
                        return `
                            <div class="d-flex gap-1 justify-content-center flex-nowrap">
                                <a href="/agencias-delta/${row.id}/edit" class="btn btn-sm btn-success" title="Editar">
                                    <i class="ri-pencil-line"></i>
                                </a>
        ...
        $('#btnFiltroEmpresaDelta').on('click', function() {
            empresaFiltro = 'delta';
            aplicarEmpresaBotones();
            table.ajax.reload();
        });
        ...
        $('#tableAgencias').on('click', '.btn-delete', function() {
            var id = $(this).data('id');
            var form = $('#deleteForm');
            form.attr('action', '/agencias-delta/' + id);
        ...
        btnPreviewTerminalesMasivo.on('click', function() {
            ...
            $.ajax({
                url: '{{ route('agencias-delta.mass-update-preview') }}',
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    var listado = noEncontradas.length
                        ...
                        : '<small class="text-success">Todas las terminales le&iacute;das existen en la tabla de agencias Delta.</small>';
