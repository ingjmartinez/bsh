                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('agencias-delta.index') }}">Agencias</a></li>
                                ...
                                <div class="row g-2 align-items-end">
                                    ...
                                    <div class="col-md-4">
                                        <div class="d-flex flex-wrap justify-content-md-end gap-2">
                                            ...
                                            <button class="btn btn-info text-white btn-sm" id="btnGenerarTokenDelta">
                                                <i class="ri-shield-keyhole-line me-1"></i> Token Delta
                                            </button>
                                            ...
                                            <a href="{{ route('agencias-delta.index') }}" class="btn btn-light btn-sm">
...
<script>
    ...
    const URL_LIST = '{{ route('agencias-delta.asistencia-comparativa.list') }}';
    const URL_SEND_MAIL_COORD = '{{ route('agencias-delta.asistencia-comparativa.send-mail') }}';
    ...
    async function solicitarCorreoYEnviar(row) {
        ...
        $.ajax({
            url: '{{ route('agencias-delta.incumplimientos.send-mail') }}',
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                email: result.value,
    ...
    function generarTokenDelta() {
        Swal.fire({
            title: 'Iniciando sesión Delta...',
            allowOutsideClick: false,
            didOpen: () => Swal.showLoading(),
        });
        ...
        $.getJSON(URL_TOKEN_NET)
            .done(function(resp) {
                Swal.fire('Listo', resp?.success || 'Sesión de Delta iniciada correctamente.', 'success');
            })
            .fail(function(xhr) {
                const msg = xhr?.responseJSON?.message || 'No se pudo iniciar sesión Delta.';
                Swal.fire('Error', msg, 'error');
            });
    }
    ...
    $(document).ready(function() {
        ...
        $('#btnGenerarTokenDelta').on('click', generarTokenDelta);
