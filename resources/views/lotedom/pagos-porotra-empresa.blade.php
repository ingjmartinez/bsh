                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Pagos Por Otra Empresa - Lotedom</h4>
...
@section('script')
    <script>
        ...
        btnGenerarData.addEventListener('click', () => {
            ...
            fetch(`/get-pagos-porotra-empresa-lotedom?fecha=${fecha}`)
                .then(response => response.json())
                .then(data => {
                    if (data.code != 0) {
                        Swal.fire({
        ...
        btnGuardarData.addEventListener('click', () => {
            ...
            fetch(`/save-pagos-porotra-empresa-lotedom?fecha=${fecha}`)
                .then(response => response.json())
                .then(data => {
                    Swal.fire({
                        title: "Listo",
        ...
        btnEliminarData.addEventListener('click', () => {
            ...
            fetch(`/delete-pagos-porotra-empresa-lotedom?fecha=${fecha}`)
                .then(response => response.json())
                .then(data => {
                    Swal.fire({
                        title: "Listo",
        ...
        btnGuardarDataFecha.addEventListener('click', async () => {
            ...
            try {
                ...
                for (let i = 0; i < dates.length; i++) {
                    ...
                    const result = await requestJson(`/save-pagos-porotra-empresa-lotedom?fecha=${date}`);
        ...
        btnEliminarDataFecha.addEventListener('click', async () => {
            ...
            try {
                ...
                for (let i = 0; i < dates.length; i++) {
                    ...
                    const result = await requestJson(`/delete-pagos-porotra-empresa-lotedom?fecha=${date}`);
                    const payload = result.payload || {};
                    responses.push({
                        date,
