                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #405189 0%, #0ab39c 100%); padding: 30px 40px; text-align: center;">
                            <h1 style="color: #ffffff; margin: 0; font-size: 24px; font-weight: 700;">
                                Bienvenido a Business Support Hub
                            </h1>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #495057; font-size: 15px; margin: 0 0 25px; line-height: 1.6;">
                                Se ha creado una cuenta para ti en el sistema ERP de <strong>BSH Support</strong>. A continuacion encontraras tus datos de acceso:
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 20px 25px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="color: #878a99; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px;">Contrasena</span><br>
