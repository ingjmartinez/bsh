...
@section('script')
    <script>
        ...
        const modules = [
            ...
            { name: 'Pago Agente (Lotedom)', type: 'list', url: '/incentivos/list/pago-incentivos-agente', saveUrl: '/incentivos/save/pago-incentivos-agente', sistema: 'Lotedom' },
            ...
            { name: 'Pago Coordinador (Lotedom)', type: 'list', url: '/incentivos/list/pago-incentivos-coordinador', saveUrl: '/incentivos/save/pago-incentivos-coordinador', sistema: 'Lotedom' },
            ...
            { name: 'Pago Admin (Lotedom)', type: 'list', url: '/incentivos/list/pago-incentivos-admin', saveUrl: '/incentivos/save/pago-incentivos-admin', sistema: 'Lotedom' }
        ];
